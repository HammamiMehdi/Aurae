...
const ProfileModeleBook: React.FC = () => {
    ...
    <div className="w-full bg-white py-16">
      ...
      <div className="w-full mb-12" style={{ padding: '0 20px' }}>
        <div className="mb-6">
          ...
          >
            Découvrez mes différents shootings et collaborations. 
            Un aperçu de mon univers et de ma polyvalence dans le monde de la mode.
          </div>
        </div>
      </div>
...
export default ProfileModeleBook;